...
public class TokenService {
	...
	@Value("{billing.jwt.expiration}")
	private String expiration;

	@Value("{billing.jwt.secret}")
	...
	public String gerarToken(Authentication authentication) {
		...
		return Jwts.builder().setIssuer("API do Billing Report").setSubject(logado.getId().toString()).setIssuedAt(hoje)
